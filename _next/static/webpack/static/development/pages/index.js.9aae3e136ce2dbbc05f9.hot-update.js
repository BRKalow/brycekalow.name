...
var makeDots = function makeDots() {
  for (var i = 0; i < 25; i++) {
    ...
    dots.push({
      ...
      width: makeRandomInt(5, shape === 'line' ? 15 : 10),
      rotate: makeRandomInt(0, 180),
      color: colors[makeRandomInt(0, shapes.length - 1)],
      shape: shape
    });
  }
};
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, dots.map(function (_ref, i) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
      ...
      style: {
        ...
        backgroundColor: shape === 'square' ? 'transparent' : color,
        borderColor: color,
        border: shape === 'square' ? '1px solid' : '',
        zIndex: -1,
...
//# sourceMappingURL=index.js.9aae3e136ce2dbbc05f9.hot-update.js.map