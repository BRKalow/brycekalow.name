    ...
    <>
        ...
        <div className="header-content">
          ...
          <nav>
            <ul ref={wrapperRef} onMouseLeave={resetHighlight}>
              <li>
                <NavigationLink href="/" onMouseOver={moveHighlight}>
                  Home
                </NavigationLink>
              </li>
              <li>
      ...
      <style jsx>{`
        ...
        .header-content {
          ...
          padding: 1.5em 0;
          display: grid;
          grid-template-areas: "avatar name nav";
        ...
        @media (max-width: 475px) {
          ...
          .header-content {
            ...
            height: 80px;
            box-sizing: border-box;
            grid-template-areas: "avatar name nav settings";
            grid-template-columns: 65px auto 0 80px;
          }
